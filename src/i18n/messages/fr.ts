...
export const fr = {
  ...
  atelier: {
    ...
    stock: {
      ...
      panelNameLabel: 'Nom du panneau',
      panelNamePlaceholder: 'Ex : MDF 19mm atelier',
      presetNameLabel: 'Nom pour la sauvegarde',
      presetNamePlaceholder: 'Ex : Chêne 244×122',
      nameDuplicate: 'Ce nom est déjà utilisé par un autre panneau.',
      presetDuplicate: 'Ce panneau est déjà sauvegardé sous « {name} ».',
      presetSavedOk: 'Panneau « {name} » sauvegardé.',
      presetDeleted: 'Panneau supprimé de la liste.',
      grainToggle: 'Panneau avec ramage',
      grainToggleAria: 'Ce panneau présente un ramage (veine du bois)',
      grainOrientationAria: 'Sens du ramage du panneau',
      grainVertical: 'Ramage vertical',
      grainHorizontal: 'Ramage horizontal',
    ...
    unplaced: {
      ...
      noStock: 'pas assez de panneaux en stock',
      more: '+ {count} autres pièces non placées',
    },
    plan: {
  ...
  pieces: {
    ...
    row: {
      ...
      grainTitle: {
        none: 'Ramage : aucun (cliquer pour verrouiller vertical)',
        vertical: 'Ramage vertical verrouillé',
        horizontal: 'Ramage horizontal verrouillé',
      },
      grainAria: 'Changer le ramage de {name}',
  ...
  historyPage: {
      scanThumbAlt: 'Photo de la fiche de débit scannée pour {name}',
      pdfAria: 'Télécharger le PDF du projet {name}',
      pdfLabel: 'PDF',
